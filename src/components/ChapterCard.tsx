...
// Map chapter numbers to Greek numerals
const greekNumerals = ["Ι", "ΙΙ", "ΙΙΙ", "ΙV", "V", "VI", "VII", "VIII", "IX"];

const ChapterCard = ({ chapterNumber, title, description, imagePath }: ChapterCardProps) => {
  const [imageError, setImageError] = useState(false);

  // Get Greek numeral for chapter
  const greekNumber = greekNumerals[chapterNumber - 1] || chapterNumber;
